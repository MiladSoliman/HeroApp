...
class MokeJsonResponse {
    static let mokeUpcomingEvents = """
{
  "success": 1,
  "result": [
    {
...
"""
  ...
  static let mokeTeamsForLeagues = """
{
  "success": 1,
  "result": [
    {
